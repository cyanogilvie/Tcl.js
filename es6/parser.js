...
export const END		= 6;
export const SCRIPT		= 7;
export const COMMENT	= 8;
export const EXPAND		= 9;
export const SYNTAX		= 10;
export const OPERAND	= 11;
export const OPERATOR	= 12;
export const LPAREN		= 13;
export const RPAREN		= 14;
export const FLOAT		= 15;
export const INTEGER	= 16;
export const MATHFUNC	= 17;
export const BOOL		= 18;
export const EXPR		= 19;
export const ARG		= 20;
export const QUOTED		= 21;
export const BRACED		= 22;
export const SCRIPTARG	= 24;
export const EXPRARG	= 25;
export const SUBSTARG	= 26;
//export const SWITCHARG = 27;  No longer used - switch parses to LISTARG now
export const LISTARG	= 28;
